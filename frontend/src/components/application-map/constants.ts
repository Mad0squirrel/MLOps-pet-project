...
const apartmentsSourceId = "apartments-source";
const apartmentsLayerId = "apartments-layer";
const apartmentsHeatmapLayerId = "apartments-heatmap-layer";
const apartmentsDataPath = "/apartments.geojson";
const apartmentsPriceField = "price";
const apartmentsApartmentField = "apartment";
